...
- Es gibt **kein Prüfskript**. Ohne automatisches Rendern und Messen sind `audit` und die Prüfliste nur Anweisungen an Claude. Bis das Skript existiert, gelten nur aus der Datei gelesene oder berechnete Werte als Pass/Fail, Füllgrad und optische Ausrichtung werden als "nicht gemessen" berichtet.
