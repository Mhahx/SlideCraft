...
1. **Brief.** One question round on purpose, situation, look and boundaries, following `references/direction.md` ("Round 1"). If questions were already asked before this skill loaded, ask only the missing Round 1 items in the next message (most often the look), never the same questions twice. Missing data becomes a placeholder, never an invention. If nobody can answer, mark assumptions and go on.
